...
export default function TrendingCourses() {
  ...
  useEffect(() => {
    async function fetchTrending() {
      const courses = await repo.getTrendingCourses();
      setCourses(courses);
      setLoading(false);
    }
    fetchTrending();
    ...
    <div className="animate-fade-in" style={{ paddingBottom: "4rem" }}>
      ...
      <div
        ...
        style={{
          ...
          textAlign: "center",
          background:
            "linear-gradient(135deg, rgba(243, 139, 168, 0.05) 0%, rgba(203, 166, 247, 0.05) 100%)",
      ...
      >
        ...
        >
          {/* <GiFlowerEmblem
            style={{ width: "3rem", height: "3rem", color: "var(--danger)" }}
          /> */}
        </div>
        <h1
        ...
        >
          Discover the most loved and highly-rated embedded systems courses by
          the community.
        </p>
      </div>
